...
<script lang="ts">
	...
	import * as DropdownMenu from '../../primitives/dropdown-menu/index.js';
	import { buttonVariants } from '../../primitives/button/index.js';

	let { variant = 'outline', size = 'icon' }: ThemeSelectorProps = $props();
</script>
