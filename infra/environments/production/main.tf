...
module "observability" {
  ...
  log_groups = {
    amp         = { name = "/aws/aps/${local.name}", retention_in_days = 90 }
    application = { name = "/deepref/${local.environment}/application", retention_in_days = 90 }
    adot        = { name = "/deepref/${local.environment}/adot", retention_in_days = 90 }
  }
